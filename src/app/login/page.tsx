  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'auth/invalid-credential' || err.code === 'auth/user-not-found' || err.code === 'auth/wrong-password') {
        ...
        msg = 'Příliš mnoho pokusů. Zkuste to prosím později.';
      }
      setError(msg);
    } finally {
      setSubmitting(false);
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-zinc-900 mb-2">Přihlášení</h1>
            <p className="text-zinc-600">Přihlaste se k vašemu účtu</p>
          </div>
          ...
          <button
            ...
            className="w-full bg-white border-2 border-zinc-200 text-zinc-900 py-3 px-4 rounded-lg font-medium hover:border-primary hover:bg-zinc-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-zinc-500">nebo emailem</span>
            </div>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-zinc-500">nemáte účet?</span>
            </div>
          </div>
          ...
          <div className="text-center">
            <Link
              href="/registrace"
              className="inline-block w-full bg-primary text-white py-3 px-4 rounded-lg font-medium hover:bg-primary/90 transition-colors"
            >
          ...
          <div className="mt-6 pt-6 border-t border-zinc-200">
            <p className="text-xs text-zinc-500 text-center">
              Po registraci vás kontaktujeme ohledně nastavení cenových skupin a přístupových práv.
            </p>
          </div>
        </div>
      </div>
