...
function Katalog2Content() {
    ...
    const [ebikeOnly, setEbikeOnly] = useState<'all' | 'ebike' | 'non'>('all');
    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                ...
                const res = await fetch(`/api/katalog2?${params.toString()}`, { cache: 'no-store' });
    ...
    return (
        <main className="min-h-screen bg-zinc-50 pb-20">
            ...
            <div className="container-custom py-8">
                {/* Page Title */}
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-zinc-900">Katalog V2</h1>
                    <p className="text-sm text-zinc-500 mt-1">Produkty z nového importu (products_v3)</p>
                </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            <div className="relative flex-1 max-w-md">
                                ...
                                <input
                                    ...
                                    placeholder="Hledat model, značku, kód..."
                                />
                            </div>
                            <span className="text-sm text-zinc-500">{total} produktů</span>
                        </div>
