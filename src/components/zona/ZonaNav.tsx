...
export const ZONA_NAV: ZonaNavItem[] = [
    ...
    { href: '/zona/feedy', label: 'Feedy', description: 'Produktové feedy pro váš e-shop (XML/CSV/JSON)', icon: 'M12.75 19.5v-.75a7.5 7.5 0 00-7.5-7.5h-.75m0-6.75h.75c8.284 0 15 6.716 15 15v.75M6 18.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z', partnerOnly: true },
    ...
    { href: '/zona/reklamace', label: 'Reklamace', description: 'Servisní případy a reklamace', icon: 'M12 9v2m0 4h.01m8.618-9.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', partnerOnly: true },
